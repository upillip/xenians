...
export default function Advisory() {
  ...
  return (
    <section id="advisory" className="py-24 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-midnight font-bold mb-6 leading-tight">
            ...
            <div className="bg-gray-50 border-l-4 border-gold p-6 italic text-gray-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {features.map((feature, idx) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-midnight mb-3">{feature.title}</h3>
